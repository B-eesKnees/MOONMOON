        ...
        <div class="goods_items">
            <div v-for="i in 4" class="goods_item">
                ...
                <div class="goods_item_info">
                    ...
                    <p class="goods_item_info_summary">간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약
                        설명 간단
                        요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 </p>
                    <div class="goods_item_info_star">
                        <span class="goods_item_info_star_num">9.3</span>
