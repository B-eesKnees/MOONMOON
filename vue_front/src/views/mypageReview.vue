                    ...
                    <div>
                        <div v-for="(review, index) in reviewList" :key="index" class="review-info">
                            ...
                            <div class="info-item1">
                                <div class="info-title.confirm info-title-row">구매확정 <span>{{
                                    formattedDate(review.ORDERITEM_CONFIRMED_AT) }}</span>
                                </div>
                            ...
                            <div class="info-item2">
                                <router-link :to="`/detail/${review.ORDERITEM_BOOK_ID}`"><button class="review-button">리뷰
                                        쓰기</button></router-link>
                                <div class="info-item2-column">
                                    <div class="info-title.deadline info-content-first">작성기한</div>
                                    <div class="info-content.deadline info-content-bold">{{
                                        calculateDeadline(review.ORDERITEM_CONFIRMED_AT) }}
                                    </div>
                                </div>
                                <div class="info-item2-column">
