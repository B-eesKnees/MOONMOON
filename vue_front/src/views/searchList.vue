<template>
    ...
    <div class="search">
        ...
        <div class="search_items">
            <div v-for="i in 4" class="search_item">
                <div class="search_item_img">
                    <img src="../assets/img/book4.jpg" alt="">
                </div>
                <div class="search_item_info">
                    <h2 class="search_item_info_title">2023 시나공 정보처리기사 실기</h2>
                    <span class="search_item_info_author">김정준 | 2023.06.24</span>
                    <div class="search_item_info_price">
                        <span>23.000</span>
                        <span>원</span>
                    </div>
                    <p class="search_item_info_summary">간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약
                        설명 간단
                        요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 간단 요약 설명 </p>
                    <div class="search_item_info_star">
                        <span class="search_item_info_star_num">9.3</span>
...
.search_item_info_price span:first-child {
    font-weight: bold;
    font-size: large;
}

.search_item_info_star {
    width: 100%;
}

.search_item_info_star_num {
    font-weight: bold;
    padding-right: 2%;
}
